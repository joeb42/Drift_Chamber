...
class DriftChamber:
    ...
    def animate(self, vmin=1e-4, vmax=1):
        ...
        self.im = plt.imshow(self.grid, origin='lower', cmap=my_cmap, extent=[0, 50, 0, 30],
                             norm=LogNorm(vmin=vmin, vmax=vmax))
        self.ax.set_xlabel('y coordinate (cm)')
        self.ax.set_ylabel('z coordinate (cm)')
        self.anim = animation.FuncAnimation(self.fig, self.__ani, init_func=self.__init, blit=True,
